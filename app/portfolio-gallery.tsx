...
export default function PortfolioGallery({motion}:{motion:boolean}) {
  ...
  return <section className="portfolio-section section-pad" id="portfolio" aria-labelledby="portfolio-title">
    <div className="section-heading reveal"><span className="eyebrow">02 / PORTFOLIO MARKETINGOWE</span><div className="heading-row"><h2 id="portfolio-title">Pomysły, które<br/>stały się <em>treścią.</em></h2><p>Rolki i grafiki dla marek z branży beauty, wnętrzarskiej, biznesowej i nie tylko.</p></div></div>
